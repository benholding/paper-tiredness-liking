...
Figure1$D <- Figure1$sleep.time + theme_bw() + scale_y_continuous(name="Liking one's partner", limits=c(1,7), breaks=seq(1,7), labels=paste(seq(1,7),sep=",")) + scale_x_continuous(name="Sleep duration (hours)", limits=c(90,690), breaks=c(120,240,360,480,600), labels=c(2,4,6,8,10))+ labs(tag = "D")
